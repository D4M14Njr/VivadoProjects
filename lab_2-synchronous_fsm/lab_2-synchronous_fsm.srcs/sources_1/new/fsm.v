...
parameter [30:0] e = 32'b01110001_10100011011011100010111; //0.0001
        ...
        case(state)
            ...
            S1: if (input_enable) begin
                if (first_one == 4'd15)
                    ...
                    MATRIX[i][j] <= {data[15], 8'd127 + first_one, data[14:0] << (4'd15 - first_one), 8'b0};
                state <= S2;
            end
            S2: begin
                if (j == 2) begin
            ...
            begin                
                if (first_one == 4'd15)
                    ...
                    VECTOR[i] <= {data[15], 8'd127 + first_one, data[14:0] << (4'd15 - first_one), 8'b0};
